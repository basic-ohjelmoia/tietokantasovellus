                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>Max. Range</td><td>Min. Range</td><td>Ammo Count</td><td>Physical Volume</td><td>Locations Allowed</td><td>Unit Cost</td><td>Number of Installs</td>
                                </tr>
                        ...
                        <form action="komponenttieditoi" method="POST" role="form">
                            ...
                            <div class="form-group">
                                <label class="radio-inline">
                                    ...
                                    <input type="hidden" name="weaponid" value="${komponentti.komponentti_id}"/>
                                </label>
                            </div>


                            <div class="form-group">
                                <label for="Component Name">Weapon name: ${komponentti.nimi}</label>
                                <input type="hidden" name="weaponname" id="weaponname" value="${komponentti.nimi}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="damage" id="damage" value="14"> 14
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="damage" id="damage" value="15"> 15
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="damage" id="damage" value="16"> 16
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="damage" id="damage" value="17"> 17
                                </label>
                                <label class="radio-inline">
