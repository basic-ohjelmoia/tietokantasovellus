...
public class Kayttaja {
    ...
    public static List<Kayttaja> getKayttajat() throws NamingException, SQLException {
        ...
        while (tulokset.next()) {
            ...
            if (tulokset.getInt("oikeustaso") > 0) {
                k.setOikeustaso(tulokset.getInt("oikeustaso"));
            }
...
//  kayttajat.add(new Kayttaja(999, "none", "nopw"));
    ...
    /**
     * Sovelluksen toiminnan kannalta tarpeettomaksi osoittautunut metodi, joka lisäisi käyttäjälle uuden MechKokoelma-merkinnän.
     * @param id
    ...
    /**
     * Kurssin ohjeista tuttu metodi, jolla tutkitaan käyttäjänimen ja salasanan vastaavuutta
     * @param nimi Nimi jota haetaan
     * @param salasana Salasana joka syötettiin
     * @return Palauttaa Käyttäjä-olion, jos salasana oli oikeim
     * @throws NamingException
     * @throws SQLException 
     */
    ...
    /**
     * Hakee käyttäjän tietyllä käyttäjä_id:llä ilman sen kummempia tarkistuksia.
     * @param kayttaja_id käyttäjän tunnistin
    ...
    /**
     * Jos oikeustaso on enemmän kuin nolla, tämä metodi palauttaa true
     * @return 
     */
    public boolean onkoAdmin() {
        if (this.oikeustaso > 0) {
            return true;
        }
        return false;
    }
